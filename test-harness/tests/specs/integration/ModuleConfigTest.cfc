...
component extends="coldbox.system.testing.BaseTestCase" appMapping="/root"{
	...
	function run(){
		...
		describe( "ModuleConfig Suite", function(){
			...
			it( "Tests the module activation", function(){
				var controller = application.cbController;
				expect( controller.getModuleService().isModuleRegistered( "cbcommerce-admin" ) ).toBeTrue();
			} );
